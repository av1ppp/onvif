...
// SetVideoEncoderConfiguration forwards the call to onvif.Do then parses the payload of the reply as a SetVideoEncoderConfigurationResponse.
func SetVideoEncoderConfiguration(ctx context.Context, dev *onvif.Device, request *onvif.Req[media.SetVideoEncoderConfiguration]) (media.SetVideoEncoderConfigurationResponse, error) {
