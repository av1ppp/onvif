...
func CallWithLogging_GetServiceCapabilities(ctx context.Context, logger *logx.Logger, dev *onvif.Device, request media.GetServiceCapabilities) (media.GetServiceCapabilitiesResponse, error) {
	type Envelope struct {
		Header struct{}
		Body   struct {
			GetServiceCapabilitiesResponse media.GetServiceCapabilitiesResponse
